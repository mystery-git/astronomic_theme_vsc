...
Use this theme if your whole set up is Astral (uv, ruff, ty) or you just really like the colors!

**Currently available for**:

-  [Visual Studio Code (VSC) and VSC-based editors](https://github.com/mystery-git/astronomic_theme_vsc)
    - Visual Studio Code/Codium, Cursor, Windsurf, Antigravity, etc
    - Any others that support [Open VSX](https://open-vsx.org/) extension themes
...
#### Method 1 (easiest)
Install the theme directly from inside your editor (VS Code, VS Codium, Cursor, etc).
...
Feel free to contribute to this project by opening up a **[new issue](https://github.com/mystery-git/astronomic_theme_vsc/issues/new/choose)** if you spot any **unthemed** or out of place colors inside the IDE so it can be fixed ASAP.

See **[CONTRIBUTING.md](CONTRIBUTING.md)** for more information.

---

##### **DISCLAIMER:** This project has no direct association with **Astral** nor is it endorsed by them.

###### <p style="color:grey"> *Made with care by [Mystery Git](https://github.com/mystery-git)* </p>
